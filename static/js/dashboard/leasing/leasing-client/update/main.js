/**
 * Manages the leasing client update page interactions and form submissions
 */
class UpdateLeasingClientManager {
    constructor() {
        // Initialize modal
    ...
    async handleLeasingClientFormSubmit(event) {
        ...
        try {
            ...
            window.toastManager.buildToast()
                .setMessage(gettext('Leasing client updated successfully'))
                .setType('success')
            ...
            this.handleError(error, gettext('Error updating leasing client'), gettext('Please correct the errors and try again.'));
        } finally {
...
/**
 * Initialize UpdateLeasingClientManager on DOM load
 */
document.addEventListener('DOMContentLoaded', () => {
    new UpdateLeasingClientManager();
});
