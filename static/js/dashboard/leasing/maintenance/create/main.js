// DOCUMENT filename="main.js" (for create.html)
/**
 * Manages the maintenance creation page interactions and form submissions
 */
class CreateMaintenanceManager {
    constructor() {
        // Initialize forms
    ...
    async handleMaintenanceFormSubmit(event) {
        ...
        try {
            ...
            window.toastManager.buildToast()
                .setMessage(gettext('Maintenance created successfully'))
                .setType('success')
            ...
            this.handleError(error, gettext('Error creating maintenance'), gettext('Please correct the errors and try again.'));
        } finally {
...
/**
 * Initialize CreateMaintenanceManager on DOM load
 */
document.addEventListener('DOMContentLoaded', () => {
    new CreateMaintenanceManager();
});
