/**
 * Manages the incident update page interactions and form submissions
 */
class UpdateIncidentManager {
    constructor() {
        // Initialize forms
    ...
    async handleIncidentFormSubmit(event) {
        ...
        try {
            ...
            window.toastManager.buildToast()
                .setMessage(gettext('Incident updated successfully'))
                .setType('success')
            ...
            this.handleError(error, gettext('Error updating incident'), gettext('Please correct the errors and try again.'));
        } finally {
...
/**
 * Initialize UpdateIncidentManager on DOM load
 */
document.addEventListener('DOMContentLoaded', () => {
    new UpdateIncidentManager();
});
