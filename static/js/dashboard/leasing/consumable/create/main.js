/**
 * Manages the consumable creation page interactions and form submissions
 */
class CreateConsumableManager {
    constructor() {
        // Initialize forms
...
/**
 * Initialize CreateConsumableManager on DOM load
 */
document.addEventListener('DOMContentLoaded', () => {
    new CreateConsumableManager();
});